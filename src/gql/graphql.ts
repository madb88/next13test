...
export type CartCreateMutation = { createOrder?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> } | null };
...
export type CartGetByIdQuery = { order?: { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> } | null };

export type CartGetOrderByIdQueryVariables = Exact<{
  orderId: Scalars['ID']['input'];
}>;


export type CartGetOrderByIdQuery = { order?: { orderItems: Array<{ quantity: number, id: string, product?: { name: string } | null }> } | null };

export type CartFragment = { id: string, orderItems: Array<{ id: string, quantity: number, product?: { id: string, name: string, price: number, description: string, images: Array<{ id: string, url: string }> } | null }> };
...
export type CartSetItemQuantityMutation = { updateOrderItem?: { id: string } | null };
...
export type UpdateProductMutation = { updateOrderItem?: { id: string } | null };

export type ColorsGetListQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;
...
export type ProductsGetByCategoryNameQuery = { products: Array<{ id: string, name: string, price: number, rating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string }> }>, productsConnection: { aggregate: { count: number }, pageInfo: { pageSize?: number | null } } };
...
export type ProductsGetByCollectionNameQuery = { collections: Array<{ products: Array<{ id: string, name: string, price: number, rating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string }> }> }> };
...
export type ProductsGetListQuery = { products: Array<{ id: string, name: string, price: number, rating?: number | null, categories: Array<{ name: string }>, images: Array<{ url: string }> }>, productsConnection: { aggregate: { count: number } } };
...
export type SizesGetListQuery = { productSizeVariants: Array<{ id: string, name: string }> };
...
export const ProductFragmentFragmentDoc = new TypedDocumentString(`
  ...
  rating
    ...
    `, {"fragmentName":"ProductFragment"}) as unknown as TypedDocumentString<ProductFragmentFragment, unknown>;
...
export const CartGetOrderByIdDocument = new TypedDocumentString(`
  ...
  order(where: {id: $orderId}) {
    ...
    `) as unknown as TypedDocumentString<CartGetOrderByIdQuery, CartGetOrderByIdQueryVariables>;
